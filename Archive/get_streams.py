...
if __name__ == "__main__":
    dem = r"C:\Users\AlexThornton-Dunwood\OneDrive - Lichen Land & Water\Lichen Drive\Projects\20240007_Atlas Process (GRMW)\07_GIS\Data\LiDAR\rasters_USGS10m\output_USGS10m_projected_clip.tif"
    output_dir = r"C:\Users\AlexThornton-Dunwood\OneDrive - Lichen Land & Water\Lichen Drive\Projects\20240007_Atlas Process (GRMW)\07_GIS\Data\LiDAR"
    thresholds = [1000, 10000, 100000]
    for threshold in thresholds:
        out_dir = os.path.join(output_dir, f"Streams_{threshold}k")
        get_streams(dem, out_dir, threshold=threshold, overwrite=False, breach_depressions=True)
